...
class App extends Component{
  constructor(props) {
    ...
    this.clicaBtn = this.clicaBtn.bind(this)
    ...
    this.frases = [
      ...
      'O bom-senso vai mais longe do que muito conhecimento. Quem quer colher rosas deve suportar os espinhos. ',
      ...
      'A gente há obtém a troco de nada.',
      'O riso é a menor distância entre duas pessoas. ',
      'Você é jovem apenas uma vez. ',
      'Depois precisa inventar outra desculpa. ',
      ...
      'Deixe de lado as preocupações e seja feliz. ',
      'A vontade das pessoas é a melhor das leis. Nós somos o que pensamos. ',
      'A maior barreira para o sucesso é o medo do fracasso. ',
  ...
  render(){
    ...
    return (
      <View style={ styles.container }>
        ...
        <TouchableOpacity style={styles.botao} onPress= { this.clicaBtn }>
          <View style={styles.btnArea}>
            <Text style={styles.btnTexto}>
              Abrir biscoito da sorte
            </Text>
          </View>
        </TouchableOpacity>
      </View>
